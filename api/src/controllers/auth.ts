    ...
    try {
        ...
        if (matchedUser) {
            ...
            if (matchedPaswsord) {
                ...
                req.session.email = matchedUser.email
                req.session.firstName = matchedUser.firstName
                req.session.lastName = matchedUser.lastName
                req.session.avatar = matchedUser.avatar
